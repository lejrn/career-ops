...
if (fileExists('test/fixtures/parsers/mobileye_nuxt_jobs.py')) {
  pass('Mobileye local-parser fixture script exists');
} else {
  fail('Mobileye local-parser fixture script is missing');
}

if (fileExists('test-scan-token-comparison.mjs')) {
  pass('scan token comparison benchmark script exists');
} else {
  fail('scan token comparison benchmark script is missing');
}
